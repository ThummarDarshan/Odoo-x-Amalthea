...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const {name, email, password, companyName, country, currency} = values;
        ...
        <Col md={{ span: 6, offset: 3 }}>
          ...
          <Form>
            ...
            <Form.Group controlId="formBasicCompanyName" className="mt-3">
              ...
              <Form.Control type="text"  name="companyName" placeholder="Enter company name" value={values.companyName} onChange={handleChange} />
            </Form.Group>
            ...
            <Form.Group controlId="formBasicCurrency" className="mt-3">
              ...
              <Form.Control as="select" name="currency" value={values.currency} onChange={handleChange}>
